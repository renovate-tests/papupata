...
export default function Implement({ withMiddleware }: Params) {
  return (
    <IndexLayout>
      <Page>
        <Container>
          ...
          <h3>method implement{withMiddleware && 'WithMiddleware'}</h3>
        </Container>
        <Purpose>Implements an API using express</Purpose>
        <Usage>
